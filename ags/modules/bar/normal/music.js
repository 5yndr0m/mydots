      ...
      Overlay({
        child: Box({
          ...
          children: [
           ...
           const isVisible = () => {
             const currentPlayer = Mpris.getPlayer("");
             if (currentPlayer !== null && currentPlayer.playBackStatus == "Playing")
               return true;
             else return false;
           };
                                ...
                                EventBox({
                                  child: BarGroup({
                                    ...
                                    setup: (self) =>
                                      self.hook(Mpris, () => {
                                        const mpris = Mpris.getPlayer("");
                                        // Show the widget only if something is playing
                                        self.visible = mpris !== null;
                                      }),
                                  }),
                                  onPrimaryClick: () =>
